...
def make_stored_password(plain_password: str) -> str:
    ...
    salt_b64 = base64.urlsafe_b64encode(salt).decode() # Encode salt to base64 for storage
    ...
    hash_b64 = base64.urlsafe_b64encode(hash_bytes).decode() # Encode hash to base64 for storage
